...
<nav class="navbar navbar-inverse">
    ...
    <div style="margin:10px;">
        <h3>Lecture 8.1|LIFO, FIFO And Average Cost</h3>
        <!-- 16:9 aspect ratio -->
        <div class="embed-responsive embed-responsive-16by9" style="margin:10px;">
            <iframe width="854" height="510" src="https://www.youtube.com/embed/UGs1EXalrZo" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
    ...
    <nav>
      <ul class="pager">
        <li class="previous"><a href="amateur10.php"><span aria-hidden="true">&larr;</span> Older</a></li>
        <li class="next"><a href="amateur12.php">Newer <span aria-hidden="true">&rarr;</span></a></li>
      </ul>
	</nav>
