...
<body>
    ...
    <div>
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="USER" aria-describedby="sizing-addon1">
        </div>
        <p></p>
        <div class="input-group">
        ...
        <p></p>
        <p><a class="btn btn-primary btn-lg" href="profile.php" role="button">BACK</a><a class="btn btn-primary btn-lg" href="profile.php" role="button">SAVE</a></p>
    </div>
</body>
</html>