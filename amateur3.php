...
<nav class="navbar navbar-inverse">
    ...
    <div style="margin:10px;">
        <h3>Lecture 2.2|Transactions And Statements</h3>
        <!-- 16:9 aspect ratio -->
        <div class="embed-responsive embed-responsive-16by9" style="margin:10px;">
            <iframe width="854" height="510" src="https://www.youtube.com/embed/w62YO9-Cg20" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
    ...
    <nav>
      <ul class="pager">
        <li class="previous"><a href="amateur2.php"><span aria-hidden="true">&larr;</span> Older</a></li>
        <li class="next"><a href="amateur4.php">Newer <span aria-hidden="true">&rarr;</span></a></li>
      </ul>
	</nav>
