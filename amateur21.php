...
<nav class="navbar navbar-inverse">
    ...
    <div style="margin:10px;">
        <h3>Lecture 17|Basic Corporate Income Statement</h3>
        <!-- 16:9 aspect ratio -->
        <div class="embed-responsive embed-responsive-16by9" style="margin:10px;">
            <iframe width="640" height="390" src="https://www.youtube.com/embed/WhCuoltUoY8" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
    ...
    <nav>
      <ul class="pager">
        <li class="previous"><a href="amateur20.php"><span aria-hidden="true">&larr;</span> Older</a></li>
        <li class="next"><a href="amateur22.php">Newer <span aria-hidden="true">&rarr;</span></a></li>
      </ul>
	</nav>
