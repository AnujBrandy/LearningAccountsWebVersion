...
<nav class="navbar navbar-inverse">
    ...
    <div style="margin:10px;">
        <h3>Lecture 5|Adjusting Entries For Accruals</h3>
        <!-- 16:9 aspect ratio -->
        <div class="embed-responsive embed-responsive-16by9" style="margin:10px;">
            <iframe width="854" height="510" src="https://www.youtube.com/embed/-XhzRKZRIGQ" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
    ...
    <nav>
      <ul class="pager">
        <li class="previous"><a href="amateur6.php"><span aria-hidden="true">&larr;</span> Older</a></li>
        <li class="next"><a href="amateur8.php">Newer <span aria-hidden="true">&rarr;</span></a></li>
      </ul>
	</nav>
